...
export default function App() {
  ...
  const activityList = [
    ...
    {name: 'Dance', maxTemp: 200, minTemp: 50, maxPrecip: 12, minPrecip: 0.0001, recommendation: 'Embrace the rain and have fun. Put on some lively music and dance in your backyard or at a covered outdoor space'},
    ...
    { user ?
      <>
        ...
        <Routes >
          ...
          <Route path="/myactivity" element={ <MyActivityPage user={user} /> } />
