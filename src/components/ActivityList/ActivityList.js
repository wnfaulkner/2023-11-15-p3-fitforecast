...
export function getActivityList () {
  return(
    [
      ...
      {name: 'Outdoor Dance', indoorOutdoor: 'outdoor', maxTemp: 90, minTemp: 50, maxPrecip: 0, minPrecip: 0, recommendation: 'Embrace the rain and have fun. Put on some lively music and dance in your backyard or at a covered outdoor space'},
      ...
      {name: 'Urban Photography Stroll', indoorOutdoor: 'outdoor', maxTemp: 85, minTemp: 50, maxPrecip: 0, minPrecip: 0, recommendation: "Take advantage of pleasant weather by going on a photography stroll in your city or a nearby picturesque area. Capture the beauty of your surroundings."},
